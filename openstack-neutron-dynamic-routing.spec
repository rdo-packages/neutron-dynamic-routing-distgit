...
%changelog
* Tue Oct 20 2020 Joel Capitao <jcapitao@redhat.com> 17.0.0-2
- Enable sources tarball validation using GPG signature.

* Wed Oct 14 2020 RDO <dev@lists.rdoproject.org> 17.0.0-1
- Update to 17.0.0

* Thu Sep 24 2020 RDO <dev@lists.rdoproject.org> 17.0.0-0.1.0rc1
