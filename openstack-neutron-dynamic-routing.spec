...
rm -rf neutron_dynamic_routing.egg-info
...
mv %{buildroot}/usr/etc/neutron/policy.d/dynamic_routing.conf %{buildroot}/%{_sysconfdir}/neutron/policy.d
...
%{python2_sitelib}/neutron_dynamic_routing-*.egg-info
%exclude %{python2_sitelib}/neutron_dynamic_routing/tests
%dir %{_sysconfdir}/neutron/policy.d
%{_sysconfdir}/neutron/policy.d/dynamic_routing.conf
